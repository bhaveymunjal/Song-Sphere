  ...
  return (
    <div className="h-screen w-screen flex items-center justify-center bg-[#191624]">
      <div className="text-center ">
        ...
        <p className="text-white mt-5 mx-auto w-[60%] mb-5 font-semibold text-lg">Currently we are fetching data from Spotify API and are going to make our own database Soon. So you have to authenticate with your Spotify account to keep listening music with us. Sorry for inconvenience</p>
